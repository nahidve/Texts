# Deployment Guide for "texts" Project

This document provides a step-by-step guide to deploying the `texts` project. The architecture consists of a Node.js/Express backend, which we will deploy on **Render**, and a React/Vite frontend, which we will deploy on **Vercel**.
...
4. Fill in the deployment settings:
   - **Name**: `texts-backend` (or your preferred name)
...
7. Render will now build and deploy your backend. Once successful, copy the backend URL (e.g., `https://texts-backend.onrender.com`). You will need this for the frontend.
...
3. **Import your Git repository** containing the `texts` project.
4. In the **Configure Project** section:
   - **Project Name**: `texts-frontend`
...
6. **Environment Variables**:
   ...
   - e.g., `VITE_API_URL`: `<Your-Render-Backend-URL>` (e.g., `https://texts-backend.onrender.com`)
...
Congratulations! Your `texts` application is now live.
